...
import (
	...
	search "github.com/v8tix/mallbots-search"
	...
	"github.com/v8tix/mallbots-search/internal/config"
...
func main() {
	...
	flag.StringVar(&cfgDirFlag, "d", "/home/v8tix/Public/projects/v8tix/microservices/environments/cloud/mallbots/search/dev", "The configuration directory")
